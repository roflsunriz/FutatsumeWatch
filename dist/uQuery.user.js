...
const uq = uQuery;
    ...
    util.propFunc = (func, { self, callback, ownKeys, } = {}) => {
        const callbackFn = callback || func;
        self = self || null;
        const handler = {
            get: function (target, prop) {
                return callbackFn.apply(self, [prop]);
            },
        };
        if (ownKeys) {
    ...
    Object.assign(util.$.$Array.prototype, {
        ...
        dump: function () {
            const callback = (elm) => [
                '%c%s%c%s%c%s',
                'color: #909;',
                elm.tagName || elm.nodeName,
                'color: #009;',
                elm.id ? `#${elm.id}` : '',
                'color: #900;',
                elm.className ? '.' + Array.from(elm.classList).join('.') : '',
                '\n',
                elm,
            ];
            if (this.length <= 3) {
  ...
  ${gname}\`hoge\`
    ...
    Object.assign(uu, {
        ...
        */`, (element, eventName) => uu(element).on(eventName, evlog)),
        ...
        $: util.$,
        d: $doc,
        a: util.propFunc(function (...args) {
            return $doc.a(...args);
        }),
        i: util.propFunc(function (...args) {
            return $doc.i(...args);
        }),
        q: util.propFunc(function (...args) {
            return $doc.q(...args);
        }),
        v: util.propFunc(function (...args) {
            return $doc.v(...args);
        }),
        t: util.propFunc(function (...args) {
            return $doc.t(...args);
        }),
        tx: util.propFunc(function (...args) {
            return $doc.tx(...args);
        }),
        noop,
        con,

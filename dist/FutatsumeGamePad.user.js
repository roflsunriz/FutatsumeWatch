...
// @grant       none
// @noframes
// @downloadURL    https://github.com/roflsunriz/FutatsumeWatch/raw/main/dist/FutatsumeGamePad.user.js
// ==/UserScript==
/* eslint-disable */
// 推奨
//
...
void (async (window) => {
    const monkey = (ZenzaWatch) => {
        ...
        const _ = window._ || ZenzaWatch.lib._;
        const $ = window.jQuery || ZenzaWatch.lib.$;
        const util = ZenzaWatch.util;
        const Emitter = ZenzaWatch.modules ? ZenzaWatch.modules.Emitter : ZenzaWatch.lib.AsyncEmitter;
        ...
        const console = debugMode ? window.console : dummyConsole;
    ...
    `.trim();
        const execCommand = (command, param) => ZenzaWatch.external.execCommand(command, param);
        const speedUp = () => {
            // TODO:
        ...
        const ZenzaGamePad = (($, PollingTimer, GamePadModel) => {
            ...
            const ZenzaGamePad = (ZenzaWatch.modules ? new ZenzaWatch.modules.Emitter() : new Emitter());
            ...
            const detectGamepad = () => {
                ...
                window.console.log('%cdetect gamepad index: %s, id: "%s"', 'background: lightgreen; font-weight: bolder;', pad.index, pad.id);

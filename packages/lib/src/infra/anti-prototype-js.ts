...
interface AntiPrototypeState {
  promise: Promise<unknown> | null;
}

const AntiPrototypeJs = function (this: AntiPrototypeState): Promise<unknown> {
  ...
  const waitForDom = new Promise<unknown>((resolve) => {
  ...
  return (this.promise = waitForDom
    ...
    .then(() => {
      ...
      window.PureArray = (f.contentWindow as unknown as { Array: typeof Array } | null)!.Array;
